          ...
          <Grid container spacing={2} onChange={changeHandler}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                autoFocus
                error={!!firstNameError}
                helperText={data.firstName && firstNameError}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                autoComplete="family-name"
                error={!!lastNameError}
                helperText={data.lastName && lastNameError}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                onBlur={handleBlur("email")}
                error={!!emailError}
                helperText={data.email && emailError}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onBlur={handleBlur("confirmPassword")}
                error={!!confirmPasswordError}
                helperText={data.confirmPassword && confirmPasswordError}
              />
            </Grid>
            <Grid item xs={12}>
              <FormControlLabel
